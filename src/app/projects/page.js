  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-12 md:p-20">
      {projectsPage.map((project, i) => {
        ...
        return (
          <article className="w-full max-w-7xl mx-auto p-6 bg-gray-100 shadow-lg rounded-md my-10">
              ...
              <section className="w-full md:w-1/2 p-3">
                ...
                <div className="mt-6 flex justify-center md:justify-start gap-3">
                  {data.project_tools.map((tool, i) => {
                    return (
                      <div className="flex items-center justify-center cursor-pointer p-2 h-[60px] w-[60px] bg-white rounded-full shadow bg-no-repeat">
                        <Image
                          title={tool}
                          alt={`${tool} Icon`}
