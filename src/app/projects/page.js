          ...
          <article class="w-full max-w-7xl mx-auto p-6 bg-gray-100 shadow-lg rounded-md my-10">
            <div class="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-5">
              <section class="w-full md:w-1/2 p-3">
                ...
                />
                <nav class="flex items-center gap-5 pl-5">
              ...
              <section class="w-full md:w-1/2 p-3">
                <h1 class="py-5 text-4xl text-left border-b mb-5">
                  {data.project_title}
                </h1>
                ...
                <div class="mt-6 flex justify-center md:justify-start gap-3">
                  {data.project_tools.map((tool, i) => {
                    return (
                      <div class="flex items-center justify-center cursor-pointer p-2 h-[60px] w-[60px] bg-white rounded-full shadow bg-no-repeat">
                        <Image
                          title={tool}
                          alt={`${tool} Icon`}
